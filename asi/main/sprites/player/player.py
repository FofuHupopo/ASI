    ...
    def events_handler(self, event: pygame.event.Event):
        ...
        if len(self.find_sprites(SpriteTypes.BOSS)) == 0:
            if self.flag_dialog_end < 3:
                self.create_dialog(["Ура, дело сделано, ну всё, где выход ", "Ничего не изменилось... ",
                                    "Кажется теперь всё понятно, это всё лишь ловушка этого божества, всё это не имеет\n"
                                    "никакого значения, торговцы, сундуки, лечение, прокачка это всё лишь какая-то\n"
                                    "иллюзия, чтобы ты побольше помучался, чтобы до последнего не терял надежду выбраться отсюда...",
                                    "Голос сверху: ха-ха, надо отдать должное ты прошёл моё испытание до конца и\n"
                                    " в конце ты всё понял, ты никогда отсюда не выберешься, ты будешь скитаться здесь\n"
                                    " вечность пока не потеряешь рассудок, все вы жалкие люди, вы только и думаете\n"
                                    " о деньгах, о славе, о выгоде. Вы слишком алчны, чтобы замечать красоту\n"
                                    " и прекрасность этого мира, вы не заслуживаете жить на этом свете. Для таких как\n"
                                    " вы я и создал этот лабиринт, чтобы избавлять этот мир от таких ничтожеств как вы.\n"
                                    " Можешь стать хоть миллионером, заработать горы золота, убить здесь всех, купить\n"
                                    " все самое лучшее и стать самым сильным, ты ни за что не выйдешь отсюда.\n"
                                    " Счастливо оставаться.  Или как там у вас говорят в Испании Feliz estancia",
                                    "Гг - И почему мне сиделось у себя на родине, ради чего я поехал сюда, только ради\n"
                                    " этих галимых денег. Потратил всю свою жизнь в пустую... "], (800, 400))
                if event.type == pygame.KEYDOWN and keys[pygame.K_f]:
